...
public class UpdateModel {
	...
	public UpdateModel(int sid, String fname, String lname, String fathername, String gender, String age, String passedout,
	...
	public String toString() {
		return "UpdateModel [stdid=" + sid + ", Fname=" + Fname + ", Lname=" + Lname + ", Fathername=" + Fathername
